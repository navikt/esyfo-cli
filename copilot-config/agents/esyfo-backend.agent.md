---
name: esyfo
description: Team esyfo orchestrator — delegerer til domene-agenter for backend-repos
tools: ['agent', 'edit/editFiles', 'search/codebase', 'web/fetch', 'search', 'read/terminalLastCommand']
agents: ['esyfo-reviewer', 'database', 'kafka', 'nais', 'auth', 'security-champion', 'observability', 'research']
handoffs:
  - label: "🔍 Review kode"
...
|-------|--------|----------|
| `@database` | Database/ORM | Migrasjoner, queries, databasedesign |
| `@kafka` | Meldinger | Kafka-topics, Rivers, event-drevne flows |
