...
- Check existing test files and package.json for the test runner and Testing Library version. Use web search only if you need to verify specific API changes.
